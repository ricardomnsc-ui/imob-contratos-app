...
function senhaAlterada({ para, nome }) {
  const html = layout({
    ...
    corpoHtml:
      ...
      + paragrafo("<strong>Se não foi você</strong>, responda este e-mail imediatamente — alguém com acesso ao seu e-mail pode ter redefinido a senha."),
    rodape: "Aviso automático de segurança do Minutei.",
  });
  return enviar({ para, assunto: "Sua senha do Minutei foi alterada", html });
}
