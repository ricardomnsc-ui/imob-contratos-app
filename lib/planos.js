 ...
 */
const PLANOS = {
  gratis: { nome: "Grátis", contratosPorMes: 3, maxUsuarios: 1 },
  autonomo: { nome: "Autônomo", contratosPorMes: Infinity, maxUsuarios: 1 },
  imobiliaria: { nome: "Imobiliária", contratosPorMes: Infinity, maxUsuarios: 5 },
